...
const ko: TranslationStrings = {
  ...
  analysisSaved: "저장됨",
  analysisSaveToLibrary: "저장 공간에 저장",
  ...
  synapseNeedContentDesc: "먼저 저장 공간에서 카드를 선택하거나 콘텐츠를 분석해주세요.",
  synapseSelectCard: "저장 공간에서 카드 선택",
  synapseEmptySlot: "카드를 선택해주세요",
  synapsePickFromLibrary: "저장 공간에서 선택",
  synapseLibraryEmpty: "저장 공간에 카드가 없습니다. 먼저 콘텐츠를 분석해주세요.",
  ...
  planFeatureLibrary10: "저장 공간 (최대 10개)",
  planFeatureSynapse: "융합 비교 기능",
  planFeatureAnalysis30: "월 30회 콘텐츠 분석",
  planFeatureDNAAI: "고급 DNA 분석 + AI 인사이트",
  planFeatureLibrary1y: "무제한 1년 저장 공간",
  planFeatureSynapseAI: "융합 AI 재조합 대본",
  ...
  planFeatureLibrary2y: "무제한 2년 저장 공간",
  planFeatureSynapseUnlimited: "융합 AI 재조합 대본 (무제한)",
...
const thBase: Partial<TranslationStrings> = {
  ...
  settingsTitle: "ตั้งค่า", settingsDesc: "ตรวจสอบข้อมูลบัญชีและสถานะการสมัครของคุณ",
