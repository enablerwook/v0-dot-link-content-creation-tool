...
const ko: TranslationStrings = {
  ...
  landingFooter: "숏폼 콘텐츠 DNA 분석 & 재조합 도구. 2026 MOZAIC. All rights reserved.",
  ...
  featureRequestDesc: "MOZAIC는 당신의 창작을 진심으로 돕고 싶습니다. 제안하세요",
  ...
  settingsWelcomeTitle: "MOZAIC 앰버서더가 되신 것을 환영합니다!",
...
const en: TranslationStrings = {
  ...
  landingFooter: "Short-form Content DNA Analysis & Recombination Tool. 2026 MOZAIC. All rights reserved.",
  ...
  featureRequestDesc: "Suggest features you'd like to see added to MOZAIC.",
  ...
  settingsWelcomeTitle: "Welcome to the MOZAIC Ambassador Program!",
...
const jaBase: Partial<TranslationStrings> = {
  ...
  settings: "設定", gnbTitle: "MOZAIC", langModalTranslation: "翻訳",
  ...
  landingFooter: "ショートコンテンツDNA分析＆再構成ツール。2026 MOZAIC. All rights reserved.",
  ...
  featureRequestTitle: "機能リクエスト", featureRequestDesc: "MOZAICに追加して欲しい機能を提案してください。",
  ...
  settingsWelcomeTitle: "MOZAICアンバサダーへようこそ！", settingsWelcomeDesc: "紹介プログラムの条件を確認して始めましょう。",
...
const esBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Traducción",
  ...
  landingFooter: "Herramienta de análisis y recombinación de ADN de contenido corto. 2026 MOZAIC. Todos los derechos reservados.",
  ...
  featureRequestTitle: "Solicitud de funciones", featureRequestDesc: "Sugiere funciones que te gustaría ver en MOZAIC.",
  ...
  settingsWelcomeTitle: "?Bienvenido al programa de embajadores MOZAIC!", settingsWelcomeDesc: "Revisa los términos del programa y comienza.",
...
const frBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Traduction",
  ...
  landingFooter: "Outil d'analyse et de recombinaison d'ADN de contenu court. 2026 MOZAIC. Tous droits réservés.",
  ...
  featureRequestTitle: "Demande de fonctionnalité", featureRequestDesc: "Suggérez des fonctionnalités pour MOZAIC.",
  ...
  settingsWelcomeTitle: "Bienvenue dans le programme ambassadeur MOZAIC !", settingsWelcomeDesc: "Consultez les conditions du programme et commencez.",
...
const deBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Übersetzung",
  ...
  landingFooter: "Kurzinhalt-DNA-Analyse- & Rekombinations-Tool. 2026 MOZAIC. Alle Rechte vorbehalten.",
  ...
  featureRequestTitle: "Funktionsanfrage", featureRequestDesc: "Schlagen Sie Funktionen vor, die Sie in MOZAIC sehen möchten.",
  ...
  settingsWelcomeTitle: "Willkommen beim MOZAIC-Botschafterprogramm!", settingsWelcomeDesc: "Überprüfen Sie die Programmbedingungen und starten Sie.",
...
const zhCNBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "翻译",
  ...
  landingFooter: "短视频内容DNA分析与重组工具。2026 MOZAIC. All rights reserved.",
  ...
  featureRequestTitle: "功能请求", featureRequestDesc: "建议您希望MOZAIC添加的功能。",
  ...
  settingsWelcomeTitle: "欢迎成为MOZAIC大使！", settingsWelcomeDesc: "查看推荐计划条件并开始。",
...
const zhTWBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "翻譯",
  ...
  landingFooter: "短影音內容DNA分析與重組工具。2026 MOZAIC. All rights reserved.",
  ...
  featureRequestTitle: "功能請求", featureRequestDesc: "建議您希望MOZAIC新增的功能。",
  ...
  settingsWelcomeTitle: "歡迎成為MOZAIC大使！", settingsWelcomeDesc: "查看推薦計畫條件並開始。",
...
const ptBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Tradução",
  ...
  featureRequestTitle: "Solicitação de recurso", featureRequestDesc: "Sugira recursos que você gostaria de ver no MOZAIC.",
...
const itBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Traduzione",
  ...
  featureRequestTitle: "Richiesta funzionalità", featureRequestDesc: "Suggerisci funzionalità per MOZAIC.",
...
const viBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Dịch thuật",
  ...
  featureRequestTitle: "Yêu cầu tính năng", featureRequestDesc: "Đề xuất tính năng bạn muốn thấy trên MOZAIC.",
...
const thBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "การแปล",
  ...
  featureRequestTitle: "คำขอฟีเจอร์", featureRequestDesc: "แนะนำฟีเจอร์ที่คุณอยากให้มีใน MOZAIC",
...
const ruBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Перевод",
  ...
  explorerTitle: "Обзор", explorerDesc: "Откройте для себя анализ контент��, который вы ещё не видели",
  synapseTitle: "Синапс", synapseDesc: "Сравните и проанализируйте два контента для создания нового.",
  featureRequestTitle: "Запрос функции", featureRequestDesc: "Предложите функции, которые вы хотите видеть в MOZAIC.",
...
const arBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "ترجمة",
  ...
  featureRequestTitle: "طلب ميزة", featureRequestDesc: "اقترح ميزات تريد رؤيتها ف�� MOZAIC.",
...
const hiBase: Partial<TranslationStrings> = {
  menu: "मेन���", home: "होम", analysis: "विश्लेषण", library: "लाइब्रेरी", synapse: "सिनैप्स",
  explorer: "एक्��प्ल���रर", featureRequest: "अनुरोध", subscribe: "सदस्यता", settings: "सेटिंग्स",
  gnbTitle: "MOZAIC", langModalTranslation: "अनुवाद",
  ...
  featureRequestTitle: "फ़ीचर अनुरोध", featureRequestDesc: "MOZAIC में जोड़ने के लिए फ़ीचर सुझाएँ।",
...
const trBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Çeviri",
  ...
  featureRequestTitle: "Özellik İsteği", featureRequestDesc: "MOZAIC'e eklenmesini istediğiniz özellikleri önerin.",
...
const nlBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Vertaling",
  ...
  featureRequestTitle: "Functieverzoek", featureRequestDesc: "Stel functies voor die je in MOZAIC wilt zien.",
...
const plBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Tłumaczenie",
  ...
  featureRequestTitle: "Prośba o funkcję", featureRequestDesc: "Zaproponuj funkcje, które chcesz zobaczyć w MOZAIC.",
...
const svBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Översättning",
  ...
  featureRequestTitle: "Funktionsbegäran", featureRequestDesc: "Föreslå funktioner du vill se i MOZAIC.",
...
const idBase: Partial<TranslationStrings> = {
  ...
  gnbTitle: "MOZAIC", langModalTranslation: "Terjemahan",
  ...
  featureRequestTitle: "Permintaan Fitur", featureRequestDesc: "Sarankan fitur yang ingin Anda lihat di MOZAIC.",
...
export function LocaleProvider({ children, initialLocale = "ko", initialAutoTranslate = true }: LocaleProviderProps) {
  ...
  useEffect(() => {
    try {
      const lsLocale = window.localStorage.getItem("mozaic-locale")
      if (lsLocale && lsLocale in translations) {
        ...
        window.localStorage.removeItem("mozaic-locale")
      }
      const lsAT = window.localStorage.getItem("mozaic-auto-translate")
      if (lsAT !== null) {
        setCookie(AUTO_TRANSLATE_COOKIE_KEY, lsAT)
        setAutoTranslateState(lsAT === "true")
        window.localStorage.removeItem("mozaic-auto-translate")
      }
    } catch {
