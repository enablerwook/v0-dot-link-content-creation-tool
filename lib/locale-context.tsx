...
const jaBase: Partial<TranslationStrings> = {
  ...
  creationStep7Title: "セールスポイント", creationStep7Desc: "スクリプトに商品をどう���り込むかアイデアを考えてみましょう。",
...
const zhCNBase: Partial<TranslationStrings> = {
  ...
  landingSubtitle1: "好的艺术家模仿，伟大的艺术家窃取。", landingSubtitle2: "解码成功内容的秘密，重���为你自己的创作。",
...
const zhTWBase: Partial<TranslationStrings> = {
  ...
  creationStep1Title: "腳本撰寫（草稿）", creationStep1Desc: "參考��材���由撰寫腳本，後續逐步完善。",
