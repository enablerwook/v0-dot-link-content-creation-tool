...
const zhCNBase: Partial<TranslationStrings> = {
  ...
  landingSubtitle1: "好的艺术家模仿，伟大的艺术家窃取。", landingSubtitle2: "解码成功内容的秘密，重塑为你自己的创作。",
...
const zhTWBase: Partial<TranslationStrings> = {
  ...
  landingBetaBadge: "Beta - 立即免費開始", landingHero1: "短影音內容的DNA", landingHero2: "分析與重組",
...
const ptBase: Partial<TranslationStrings> = {
  ...
  explorerTitle: "Explorador", explorerDesc: "Descubra análises de conteúdo que você não viu antes",
...
const arBase: Partial<TranslationStrings> = {
  ...
  featureRequestTitle: "طلب ميزة", featureRequestDesc: "اقترح ميزات تريد رؤيتها في DotLink.",
