...
const plans: Plan[] = [
  {
    ...
    features: [
      ...
      { text: "익스플로러(큐레이션): 주 1회 (월 4회)" },
      { text: "라이브러리 저장: 4개" },
      { text: "시냅스 (기획안): 1개 프로젝트" },
    ],
    ctaText: "무료로 시작하기",
    ctaVariant: "outline",
  },
  {
    ...
    features: [
      { text: "DNA 분석: 월 30회" },
      { text: "익스플로러(큐레이션): 월 10회" },
      { text: "라이브러리 저장: 50개" },
      { text: "시냅스 (기획안): 10개 프로젝트" },
    ],
  ...
  },
  {
    ...
    features: [
      { text: "DNA 분석: 월 500회" },
      { text: "익스플로러(큐레이션): 월 100회" },
      { text: "라이브러리 & 시냅스: 무제한" },
      { text: "데이터 엑셀/CSV 다운로드" },
      { text: "팀원 초대 (최대 3인)", comingSoon: true },
      { text: "시냅스 공동 편집 & 폴더 무제한", comingSoon: true },
    ],
    ctaText: "Agency 시작하기",
    ctaVariant: "outline",
  },
